...
| same paying shape, 5 more cameras   |  200 |   **91** (46%)           |   4246  | 0.047/s  | **0.0214**|
...
The last row is the same lesson one level in, and then the rule out of it. Having ranked the paying shape
first at 0.0329, buying it at five further cameras pays 0.0214 -- because the 29 of 40 was that shape's
...
And what separates 0.0096 from 0.0356 across those five, on an identical shape and clock, is DISTANCE from
the cameras already bought AT PURCHASE TIME -- 19% new at ~20 BAM through 78% at 266, Spearman 0.886 over
six passes. So spread the buys and rank candidates by their distance from the ledger, not by their own
prior yield, which predicted nothing (`knowledge/strategy/clip-draw-ledger.md`).
