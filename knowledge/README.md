...
- **My best approach just improved 37x - is my axis converging, or did I enlarge a lottery? I have several axes priced on one scope, where does the clock go?** → [strategy/clip-search-budget.md](strategy/clip-search-budget.md#the-enrichment-can-be-local---and-a-record-is-not-a-trend)
