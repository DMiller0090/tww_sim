...
Link himself is a shaded **cyan 3D prism** whose pointed nose faces his heading (u16 `0x803EA3D2`;
fwd = `(sin θ, 0, −cos θ)`) — it reads over the yellow floor and shows facing at a glance.
